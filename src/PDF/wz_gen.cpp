...
bool Wicher::PDF::generate_wz(std::string outname, std::string id, std::string issuant, std::string receiver, std::string date, std::string purpose, std::string return_date, bool comment, std::vector<Wicher::PDF::Entry> entries){
	...
	const char * page_title = "Wydanie zewnętrzne";
	...
	try {
		...
		//HPDF_Page_ShowText (page, "Osoba wydająca: ");
